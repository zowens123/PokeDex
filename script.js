...
function createPokeList(pokemon) {
	...
	const pokeInnerHtml = `<ol class='pokeRow' onclick="selectPokemon(${pokemon.id});pendo.pageLoad('https://zowens123.github.io/PokeDex/${pokemon.name}')">#${pokemon.id.toString().padStart(3, "0")}: ${name}`;
